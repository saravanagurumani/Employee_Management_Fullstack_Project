...
const AddEmployeeForm = () => {
  ...
  const handleSubmit = async (event) => {
    ...
    await axios.post('http://localhost:8080/employee/add', formValues);  // Axios POST request
    alert('Employee details submitted successfully!',formValues);
    ...
    style={{ 
      ...
      <Form style={{margin: '20px'}}>
        <div className="formheader" style={{margin: '40px' ,textAlign: 'center'}}>
          <h2 style={{ fontWeight: 'bold', color: '#343a40' }}>Register Employee</h2>
        </div>
        <Row className="mb-3">
