...
## Project Workflow
- User opens the Employee Management System in a web browser.
- Frontend (React.js) displays the employee list using a GET API call.
- User adds a new employee by filling a form and submitting it (POST API call).
- User updates or deletes employee records (PUT/DELETE API calls).
- Backend (Spring Boot) processes the request and updates the MySQL database.
- Frontend UI updates dynamically to reflect changes.

## How to Run the Project Locally
### 🔹 Backend (Spring Boot)
- Install Java (JDK 17+) and Spring Boot.
- Open the project in IntelliJ IDEA or Eclipse.
- Set up MySQL database and configure application.properties:
